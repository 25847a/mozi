...
public class JpushClientUtil {
  ...
  //  private final static String masterSecret = "031539a94c5df2c84935672e";墨子星的
     ...
     * @return 0推送失败，1推送成功
     */
    public static int sendToRegistrationId( String registrationId,String notification_title, String msg_title, String msg_content, String notifyType, String notifyValue) {
        int result = 0;
        try {
            PushPayload pushPayload= JpushClientUtil.buildPushObject_all_registrationId_alertWithTitle(
            		registrationId,notification_title,msg_title,msg_content,notifyType,notifyValue);
    	 ...
    	 * @return
    	 */
     public static int sendToAlias( String alias,String notification_title, String msg_title, String msg_content, String notifyType, String notifyValue) {
        int result = 0;
        try {
            PushPayload pushPayload= buildPushObject_all_alias_alertWithTitle(alias,notification_title,msg_title,msg_content,notifyType, notifyValue);
            PushResult pushResult=jPushClient.sendPush(pushPayload);
            if(pushResult.getResponseCode()==200){
                result=1;
            }
    ...
    private static PushPayload buildPushObject_all_alias_alertWithTitle(String alias,String notification_title, String msg_title, String msg_content, String notifyType, String notifyValue) {
        ...
        return PushPayload.newBuilder()
                ...
                .setNotification(Notification.newBuilder()
                        ...
                        .addPlatformNotification(AndroidNotification.newBuilder()
                                ...
                                .setTitle(notification_title)
                                //此字段为透传字段，不会显示在通知栏。用户可以通过此字段来做一些定制需求，如特定的key传要指定跳转的页面（value）
                                //.addExtra("notifyType",notifyType)
								//.addExtra("notifyValue",notifyValue)
								.addExtra("sound","mozisound.mp3")
                                .build())
                        //指定当前推送的iOS通知
                        .addPlatformNotification(IosNotification.newBuilder()
                                //传一个IosAlert对象，指定apns title、title、subtitle等
    ...
    //江明单独发给用户
    private static PushPayload buildPushObject_all_registrationId_alertWithTitle(String registrationId,String notification_title, String msg_title, String msg_content, String notifyType, String notifyValue) {
