 ...
 * @since 2018-07-17
 */
@TableName("f_privilege_strengthen_injection")
public class PrivilegeStrengthenInjection extends Model<PrivilegeStrengthenInjection> {
    ...
    public String toString() {
        return "PrivilegeStrengthenInjection{" +
        "id=" + id +
