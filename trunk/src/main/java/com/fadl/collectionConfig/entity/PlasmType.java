 ...
 * @since 2018-04-21
 */
@TableName("f_plasm_type")
public class PlasmType extends Model<PlasmType> {
	...
	public String toString() {
		return "PlasmType [id=" + id + ", name=" + name + ", isSelected="
				+ isSelected + ", roomId=" + roomId + ", isDelete=" + isDelete
