  ...
  /**
   ...
   /**
    ...
    public static void main(String[] args) {
        double[] y = { 0, 28, 57, 97, 150  };
        double[] x = { 0.36, 0.471, 0.514, 0.616, 0.809 };
        PolynomialRegression regression = new PolynomialRegression(x, y, 3);

        // Use System.out.println() so that it works with either stdlib.jar or algs4.jar version
        System.out.println(regression.predict(0.36));
        System.out.println(regression.predict(0.471));
        System.out.println(regression.predict(0.514));
        System.out.println(regression.predict(0.616));
        System.out.println(regression.predict(0.809));
