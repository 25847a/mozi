	...
	*//***
		...
		//读取源图像
		   ...
		   if(srcWidth>=w&&srcHeight>=h){
			   ...
			   // BufferedImage originalImage=ImageIO.read(file);
			    ...
			    gh.drawImage(tag.getScaledInstance(80, 80, Image.SCALE_SMOOTH), 0, 0, null);
			    gh.dispose();
	 ...
	 *//**
		...
		*//**
		 ...
		 * @throws Exception
		 *//*
		public static void saveImage(String image,String path) throws Exception{
			byte[] by= Base64.decode(image);
		...
		*/
		public static void main(String[] args) throws Exception {
			InputStream in = new FileInputStream(new File("D:/psb.jpg"));
