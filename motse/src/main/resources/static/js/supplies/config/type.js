$(function(){
  ...
  dataAllIsOpenLimit("rumsers",cols,{"token" : getToken()},GetURLInfo() + 'queryTypeList',GetURLInfo() +'typeUpdate',GetURLInfo() + "deleteType",true,'',10);
	//搜索按钮点击事件
	...
	function getToken() {
	 ...
	 ! function() {
		 	...
		 	$('#unittAdd').on('click', function() {
		 		addWithArea(GetURLInfo() +'typeAddPage',true,[ '500px', '200px' ]);
		 		}
		 	)
		 }();
		 /**
