    ...
    data() {
        return {
            ...
            tableConfig: {
                ...
                columns: [
                    { field: 'imei', width: 120, columnAlign: 'center', isResize: true },
                    { field: 'custome', width: 60, columnAlign: 'center', isResize: true  },
                    { field: 'rate', width: 50, columnAlign: 'center', isResize: true  },
                    { field: 'gender', width: 50, columnAlign: 'center',  isResize: true },
                    { field: 'low', width: 50, columnAlign: 'center', isResize: true },
                    { field: 'hobby', width: 60, columnAlign: 'center', isResize: true },
                    { field: 'breathe', width: 60, columnAlign: 'center', isResize: true },
                    { field: 'blood', width: 50, columnAlign: 'center', isResize: true },
                    { field: 'heartbeat', width: 60, columnAlign: 'center', isResize: true },
                    { field: 'presentation', width: 500, columnAlign: 'center', isResize: true },
                    { field: 'time', width: 120, columnAlign: 'center', isResize: true }
