    ...
    data() {
        return {
            ...
            tableConfig: {
                ...
                columns: [                   
                    { field: 'number', width: 60, columnAlign: 'center', isResize: true  },
                    { field: 'name', width: 200, columnAlign: 'center', isResize: true  },
                    { field: 'age', width: 60, columnAlign: 'center', isResize: true  },
                    { field: 'sex', width: 60, columnAlign: 'center', isResize: true },
                    { field: 'phone', width: 100, columnAlign: 'center',  isResize: true },
                    { field: 'address', width: 100, columnAlign: 'center', isResize: true },
                    { field: 'eqnumber', width: 80, columnAlign: 'center', isResize: true },
...
// 自定义列组件<a href="" @click.stop.prevent="deleteRow(rowData,index)"></a>
    ...
    Vue.component('table-equipment',{
        ...
        <a href="" @click.stop.prevent="deleteRow(rowData,index)">录入</a>
        </span>`,
        // props:{
        //     rowData:{
        //         type:Object
