...
<title>化验</title>
	...
	<script type="text/javascript" src="../js/assay/new_card_list.js"></script>
</head>
<style>
	...
	<table id="table" class="table table-bordered table-hover" style="text-align: center;">
		<thead>
			<tr>
				...
				<th style='text-align: center;'>蛋白含量</th>
				<th style='text-align: center;'>血红蛋白含量</th>
				<th style='text-align: center;'>梅毒</th>
				<th style='text-align: center;'>谷丙转氨酶</th>
				<th style='text-align: center;'>乙肝表面抗原</th>
				<th style='text-align: center;'>丙肝表面抗原</th>
				<th style='text-align: center;'>艾滋病表面抗原</th>
				<th style='text-align: center;'>血型</th>
				<th style='text-align: center;'>化验结果</th>
				<th style='text-align: center;'>化验时间</th>
			</tr>
		</thead>
	</table>
</div>
